...
const Odd16 = () => {
    ...
    const handleData = (e) => {
        ...
        const putData = async () => {
            try {
                const response = await axios.patch(`https://aabd2a0302baf66f.mokky.dev/Odd_16/${id}`, {
                    homework,
                    vocabulary,
                })
    ...
    const handleAdd = (e) => {
        ...
        const putData = async () => {
            try {
                const response = await axios.post('https://aabd2a0302baf66f.mokky.dev/Odd_16', {
                    name: name,
                    homework: "0",
                    vocabulary: "0",
                    vocAll: 0,
    ...
    const handleDelete = (id) => {
        const deleteData = async () => {
            try {
                const response = await axios.delete(`https://aabd2a0302baf66f.mokky.dev/Odd_16/${id}`)
                console.log(response.data);
            } catch (error) {
                console.log(error);
            }
